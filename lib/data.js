...
module.exports.getContainerNames = function getContainerNames() {
  return getFilesBasename(`${config.get('dataRepo:path')}/input/containers`)
    .map(filename => {
...
module.exports.getTemplateGroupNames = function getTemplateGroupNames() {
  return getFilesBasename(`${config.get('dataRepo:path')}/input/templates`);
};
...
module.exports.getTemplateNamesInGroup = function getTemplateNamesInGroup(templateGroup) {
  return getFiles(`${config.get('dataRepo:path')}/input/templates/${templateGroup}`);
};
...
module.exports.getTemplateMetadata = function getTemplateMetadata(templateGroup) {
    return yaml.safeLoad(fs.readFileSync(`${config.get('dataRepo:path')}/input/templates/${templateGroup}/metadata.yml`, {encoding: 'utf8'}));
};
