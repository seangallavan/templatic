...
module.exports.saveRenderVars = function saveRenderVars(renderVars, directoryToSaveTo) {
  fs.ensureDirSync(directoryToSaveTo);
  fs.writeFileSync(`${directoryToSaveTo}/renderVars.yml`, yaml.safeDump(renderVars, {noRefs: true}));
};
